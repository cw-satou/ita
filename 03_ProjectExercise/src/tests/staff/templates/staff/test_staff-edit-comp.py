...
# スタッフ情報変更完了画面のテンプレートをテストする関数
def test_staff_edit_comp_01(client):
    """No.01 テストケース名：テンプレート「スタッフ情報変更完了画面」表示"""

    # テスト対象の編集完了画面テンプレートを指定
    template_file = "staff/staff-edit-comp.html"
